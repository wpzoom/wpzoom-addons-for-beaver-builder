...
<strong>WPZABB Pro Custom Modules</strong>
...
2. After activating Ultimate Addon for Beaver Builder, navigate to the settings page at Settings > WPZABB to configure the post types you would like it to work with.
...
For more information, please visit our <a href="https://www.ultimatebeaver.com/docs/begin-building-page-using-wpzabb/">Knowledge Base</a>. Keep in mind that not all features described in the knowledge base are available in this version of the Ultimate Addon for Beaver Builder plugin.
...
* Improvement: Deprecated wpzabb-simplify field and replaced it with BB's unit field
* Improvement: Deprecated wpzabb-spacing field and replaced it with BB's dimension field
* Improvement: Deprecated wpzabb-toggle-switch field and replaced it with BB's select field
* Improvement: Deprecated wpzabb-blank-spacer field
* Improvement: Deprecated wpzabb-msg-box field
