...
<div class="wpzabb-module-content <?php echo $module->get_classname(); ?>">
	...
	?>
		...
		<a href="<?php echo $settings->link; ?>" target="<?php echo $settings->link_target; ?>" class="wpzabb-button wpzabb-creative-button <?php echo 'wpzabb-creative-'.$settings->style.'-btn' ?> <?php echo $module->get_button_style(); ?> <?php echo ( isset( $settings->a_class ) ) ? $settings->a_class : '' ; ?> " <?php echo ( isset( $settings->a_data ) ) ? $settings->a_data : '' ; ?> role="button">
