<?php if ( $global_settings->responsive_enabled ) : ?>
	...
	@media ( max-width: <?php echo $global_settings->responsive_breakpoint . 'px'; ?> ) {
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-1 .products li { width: calc(100% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-2 .products li { width: calc(50% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-3 .products li { width: calc(33.3% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-4 .products li { width: calc(25% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-5 .products li { width: calc(20% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-6 .products li { width: calc(16.6% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-7 .products li { width: calc(14.2% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-8 .products li { width: calc(12.5% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-9 .products li { width: calc(11.1% - 30px); }
		.fl-node-<?php echo $id; ?> .wpzabb-woocommerce-products.columns-phone-10 .products li { width: calc(10% - 30px); }
	}
<?php endif; ?>