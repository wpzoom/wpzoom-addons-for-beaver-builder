...
if ( $query->have_posts() ) :
	...
	$paged = ( FLBuilderLoop::get_paged() > 0 ) ? ' wpzabb-paged-scroll-to' : '';

?>
<div class="wpzabb-post-<?php echo $module->get_layout_slug() . $paged; ?>" itemscope="itemscope" itemtype="https://schema.org/Blog">
	<?php
	...
	<div class="wpzabb-post-grid-sizer"></div>
	<?php endif; ?>
</div>
